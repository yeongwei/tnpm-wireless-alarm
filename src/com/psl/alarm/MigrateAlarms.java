...
public class MigrateAlarms {
  public static void main(String[] args) throws Exception {
    ...
    // SOURCE INFORMATION
    String sourceDbName = "10.211.48.24";
    String sourceDbPort = "1521";
    ...
    // SINK INFORMATION
    String sinkDbName = "10.211.48.24";
    ...
    Connection sourceConnection = DriverManager.getConnection(sourceJdbcUrl,
        sourceCredentials);
    ...
    Connection sinkConnection = DriverManager.getConnection(sinkJdbcUrl,
        sinkCredentials);
